    ...
    public class CommandHandler
    {
        ...
        private async Task HandleMessageAsync(SocketMessage socketMessage)
        {
            ...
            if (userMessage is null)
                return;
            char prefix = StreamMusicBotClient._config.Prefix.ToCharArray()[0];
            if (!userMessage.HasMentionPrefix(_client.CurrentUser, ref argPos) && !userMessage.HasCharPrefix(prefix, ref argPos))
                return;
